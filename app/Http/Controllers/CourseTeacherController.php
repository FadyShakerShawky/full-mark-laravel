...
class CourseTeacherController extends Controller
{
    ...
    public function extinsiveSearch()
    {
        ...
        $result = DB::table('course_teachers')
            ...
            ->select('groups.price', 'groups.discount', 'users.name as teacherName', 'teachers.id as teacherId', 'courses.name as courseName', 'groups.description', 'groups.id')
            ->limit(9)
            ->get();
        $this->searchParams = [];
        return $result;
    ...
    public function onSaleSearch()
    {
        ...
        $data = DB::table('course_teachers')
            ...
            ->select('groups.id as group_id', 'groups.price', 'groups.discount', 'users.name as teacherName', 'teachers.id as teacherId', 'courses.name as courseName', 'groups.description', 'courses.id as course_id')
            ->limit(9)
            ->get();
